...
class SchrankeManager:
    ...
    def updateShadredData(self):
        ...
        self.database.updateParkplatz(next_free_spot['key_id'],0,next_free_spot['arduino_parkplatz_id'],ParkplatzStatus.RESERVIERT_SYSTEM.value,next_free_spot['spezial'])
        print("free",free)
        print("amount",amount)
        ...
        with data_lock:
            ...
            shared_data['next_parking_spot'] = f"Reihe {next_free_spot['reihe']} Nummer {next_free_spot['parkplatz_nummer']}"
